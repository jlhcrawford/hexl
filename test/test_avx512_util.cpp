...
TEST(AVX512, avx512_add_uint64) {
  {
    ...
    __m512i c;
    __m512i carry = avx512_add_uint64(a, b, &c);
...
TEST(AVX512, avx512_cmplt_epu64) {
  // Small
  {
    ...
    __m512i c = avx512_cmplt_epu64(a, b, match_value);
...
TEST(AVX512, avx512_cmpgteq_epu64) {
  // Small
  {
    uint64_t match_value = 10;
    __m512i a = _mm512_set_epi64(0, 1, 2, 3, 4, 5, 6, 7);
    ...
    __m512i c = avx512_cmpgteq_epu64(a, b, match_value);
...
TEST(AVX512, avx512_mod_epu64) {
  // Small
  {
    ...
    __m512i c = avx512_mod_epu64(a, mods);
